            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('products.update', $product->id) }}">
                        ...
                        {{-- Available Date --}}
                        <div class="mb-4">
                            <label for="date_available" class="block text-sm font-medium text-gray-700">
                                Available Date *
                            </label>
                            <input
                                type="date"
                                name="date_available"
                                id="date_available"
                                value="{{ old('date_available', optional($product->date_available)->format('Y-m-d')) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('date_available') border-red-500 @enderror"
                                required
                            >
